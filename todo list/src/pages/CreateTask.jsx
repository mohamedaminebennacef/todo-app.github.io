...
const CreateTask = () => {
  ...
  return (
    <div className='p-4 bg-gray-900 shadow-lg h-screen'>
    <BackButton />
    <h1 className='text-3xl my-4 text-white'>Create Task</h1>
    {loading ? <Spinner /> : ''}
    <div className='flex flex-col border-2 border-sky-700 rounded-xl w-[600px] p-4 mx-auto'>
      ...
      <button className='p-2 bg-sky-700 m-8 text-white' onClick={handleSaveTask}>Save</button>
    </div>
  </div>
  )
}
